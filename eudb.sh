...
# Step 5: Download the new docker-compose-backend.yml from the specified URL
wget https://raw.githubusercontent.com/Omriak10/Edgify/main/docker-compose-backend.yml

# Rename the downloaded file to docker-compose.yml
...
# Step 8: View logs of the edgify-agent container
sudo docker logs -f edgify-agent
